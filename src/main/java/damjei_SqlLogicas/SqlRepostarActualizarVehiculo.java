...
public class SqlRepostarActualizarVehiculo {
    ...
    private static final String MANTENIMIENTO_NOK = " Tiene que ralizar el mantenimiento de ";
    private static final String MANTENIMIENTO_OK = " No hay mantenimientos pendientes ni por KM ni por Fecha ";
    private static final String POR_FECHA = " por Fecha del vehículo ";
    private static final String POR_KM = " por KM del vehículo ";
            ...
            if (!rs.next()) {
                ...
                while (rsRev.next()) {
                    ...
                    while (rsMtto.next()) {
                        ...
                        if (String.valueOf(kilometros_mantenimiento) != null) {
                            ...
                            if (fecha_actual.get(Calendar.MONTH) < ultimaRevision.get(Calendar.MONTH)
                                ...
                                if (nombre_mtto.equalsIgnoreCase("ITV")) {
                                    ...
                                    if (diferciaPrimeraItv >= 5 && diferciaFechas >= 1) {
                                        ...
                                        aviso = MANTENIMIENTO_NOK + nombre_mtto;
                                        ActuralizarRevisiones(idrevision);
                                    }
    ...
    /**
     * Actualizamos el estado de la clase revisiones de la revison que corresponda
     * 
     * @param idrevision
     * @throws SQLException 
     */
