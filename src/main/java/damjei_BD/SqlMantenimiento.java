...
public class SqlMantenimiento {
    ...
    public String InsertarMantenimiento(ArrayList<String> datos) throws SQLException, ParseException {
        ...
        String sql = """
                        ...
                        idmantenimiento, nombre, kilometros_mantenimiento)
                        VALUES (nextval('sec_idmantenimiento'), ?, ?)""";

        ps = con.prepareStatement(sql);
        //ps.setInt(1,idvehiculo);
        ps.setString(1, nombre);
        ps.setInt(2,Integer.parseInt(km));
    ...
    /**
     * obtenemos la clase a la que se quiere listar o un manteniemiento por el idmantenimineto
     *
     * @param variable
     * @return
