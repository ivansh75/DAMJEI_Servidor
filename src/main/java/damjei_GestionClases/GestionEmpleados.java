...
public class GestionEmpleados {
    ...
    public static final String EMPRESAID = "empresaid";//atributo en BD
    public static final String CONTRASEÑA = "contraseña";//atributo en BD
        ...
        if (empleatJson != null && !empleatJson.isJsonNull()) {
            ...
            switch (request.getAccion()) {
                ...
                case MODIFICAR: {
                    ...
                    request.setId_String(empleatJson.get(EMPRESAID).getAsInt());
                    request.setAccion(jsonObject.get(DATOS_ACCION).getAsInt());
