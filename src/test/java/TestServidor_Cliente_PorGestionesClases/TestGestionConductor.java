...
public class TestGestionConductor {
    ...
    /**
     * Segundo Test
     * Iniciamos primero usuario empleado como administrador
     *
     * @throws IOException
     */
    @Test
    ...
    public void TestC() throws IOException {
        ...
        System.out.println("-----INSERTAR CONDUCTOR NUEVO -----------");

        // Crear una instancia de la clase y establecer sus valores
        DatosConductor datos = new DatosConductor();
        //ArrayList<String> list = new ArrayList<>();
        ConductorObjeto conObject = new ConductorObjeto();
        conObject.setIdconductor(8);
        conObject.setFecha_carnet("1995-1-20");
        conObject.setFecha_caducidad_carnet("2005-1-30");
        conObject.setEmpleadoid(1);
    ...
    */
    ...
    /**
     * Cuarto Test para Actualizar un Conductor
     *
     * @throws IOException
     */
    @Test
    ...
    /**
     *
     * Quinto Test para Mostrar Lista de Conductores.
    ...
    /*
    /**
     * Sexto Test para Eliminar un Conductor
     *
     * @throws IOException
     *
    @Test
    ...
    */
    ...
    /**
     *
     * Octavo Test para Mostrar Lista del Conductor.
     * Vemos como esta añadido el Conductor nuevo
     *
     * @throws IOException
     */
