...
public class TestGestionVehiculo {
    ...
    /**
     *
     * Iniciamos primero usuario como administrador
     *
     * @throws IOException
     */
    @Test
    ...
    /**
     * Test para insertar un vehiculo nuevo
     *
     * @throws IOException
     */
    @Test
    public void TestC() throws IOException, ParseException {
        boolean correcte = false;
        ...
        vehicle.setFecha_alta(format.parse("2023-2-9"));
    ...
    /**
     * Test para Actualizar un vehiculo 
     *
     * @throws IOException
     */
    @Test
    ...
    /**
     *
     * Test para Mostrar Lista de vehiculos 
